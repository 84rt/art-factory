export const NFTProgramId = 'moss_fts.aleo';

export const NFTProgram = `program moss_fts.aleo;
...
function initialize_collection:
    ...
    assert.eq self.caller aleo1trhc3lahaujl8rmcu8qpcmw36lgdyekxc7m0ykz90ddnafdguqpqv67xrh;
    async initialize_collection r0 r1 r2 into r3;
    output r3 as moss_fts.aleo/initialize_collection.future;
...
function add_nft:
    ...
    output r4 as moss_fts.aleo/add_nft.future;
...
function add_minter:
    ...
    output r3 as moss_fts.aleo/add_minter.future;
...
function update_toggle_settings:
    ...
    output r1 as moss_fts.aleo/update_toggle_settings.future;
...
function set_mint_block:
    ...
    output r1 as moss_fts.aleo/set_mint_block.future;
...
function update_symbol:
    ...
    output r1 as moss_fts.aleo/update_symbol.future;
...
function update_base_uri:
    ...
    output r1 as moss_fts.aleo/update_base_uri.future;
...
function open_mint:
    ...
    output r4 as moss_fts.aleo/open_mint.future;
...
function mint:
    ...
    output r7 as moss_fts.aleo/mint.future;
...
function claim_nft:
    ...
    output r6 as moss_fts.aleo/claim_nft.future;
...
function authorize:
    ...
    output r2 as moss_fts.aleo/authorize.future;
...
function transfer_public:
    ...
    output r5 as moss_fts.aleo/transfer_public.future;
...
function convert_private_to_public:
    ...
    output r3 as moss_fts.aleo/convert_private_to_public.future;
...
function convert_public_to_private:
    ...
    output r5 as NFT.record;
    output r6 as moss_fts.aleo/convert_public_to_private.future;
